...
from app.filters.IsAdmin import get_admin_id
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    await message.reply("Я бот Oceanica. Я помогу вам выбрать и заказать лучшие экзотические растения")
...
async def callback_start(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.reply("Я бот Oceanica. Я помогу вам выбрать нужные позиции рыбы и морепродуктов и расскажу о новых поступлениях")
